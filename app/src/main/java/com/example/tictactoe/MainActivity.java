    ...
    protected void onCreate(Bundle savedInstanceState) {
     ...
     private void winningGame() {
         if ((b1==1)&&(b2==1)&&(b3==1)){
             ...
             builder.setMessage("Player X wins").setCancelable(false).setPositiveButton("OK", (dialog, which) -> {
                 button1.setImageDrawable(null);
                 button2.setImageDrawable(null);
                 button3.setImageDrawable(null);
                 button4.setImageDrawable(null);
             ...
             AlertDialog.Builder builder = new AlertDialog.Builder(this);
             builder.setMessage("Player O wins").setCancelable(false).setPositiveButton("OK", (dialog, which) -> {
                 button1.setImageDrawable(null);
                 button2.setImageDrawable(null);
                 button3.setImageDrawable(null);
                 button4.setImageDrawable(null);
             ...
             if (i==9){
                 AlertDialog.Builder builder = new AlertDialog.Builder(this);
                 builder.setMessage("No Player wins").setCancelable(false).setPositiveButton("OK", (dialog, which) -> {
                     button1.setImageDrawable(null);
                     button2.setImageDrawable(null);
                     button3.setImageDrawable(null);
                     button4.setImageDrawable(null);
